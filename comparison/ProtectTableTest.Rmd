...
unlist(sessionInfo()$loadedOnly$sdcHierarchies[c("Package", "Version", "Date")])

unlist(sessionInfo()$otherPkgs$RegSDC[c("Package", "Version", "Date")])

unlist(sessionInfo()$otherPkgs$Matrix[c("Package", "Version", "Date")])

unlist(sessionInfo()$otherPkgs$SSBtools[c("Package", "Version", "Date")])
