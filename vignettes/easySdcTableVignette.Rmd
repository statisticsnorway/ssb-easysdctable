...
Before demonstrating ProtectTable() a few word about new possibilities in this version of 'easySdcTable' is given.
...
```
The interface to tau-argus make use of new functionality in ‘sdcTable’. See the documentation of ProtectTable() for more information.
